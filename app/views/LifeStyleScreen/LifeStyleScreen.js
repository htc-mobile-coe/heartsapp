...
import { styles as lifeStyleScreenStyle } from './LifeStyleScreen.styles';
import { View } from 'react-native';
import ScreenContainer from '../shared/ScreenContainer';
import VideoCard from '../shared/VideoCard/VideoCard';
import { LIFE_STYLE_VIDEOS } from '../../shared/Constants';
import Images from './img';
import { withTheme } from 'app/styles/theme/WithThemeHOC';
import OptionsScreenHeader from '../shared/OptionsScreenHeader';

class LifeStyleScreen extends Component {
    _renderHeader = () => {
            ...
            <ScreenContainer>
                <View style={styles.mainView}>
                    ...
                    <View style={styles.bodyContainer}>
                        {this._renderCard(
                            'stressDetox',
                            LIFE_STYLE_VIDEOS.STRESS_DETOX,
                        )}
                        {this._renderCard(
                            'fearDetox',
                            LIFE_STYLE_VIDEOS.FEAR_DETOX,
                        )}
                        {this._renderCard(
                            'angerDetox',
                            LIFE_STYLE_VIDEOS.ANGER_DETOX,
                        )}
                        {this._renderCard('sleep', LIFE_STYLE_VIDEOS.SLEEP)}
                    </View>
                </View>
            </ScreenContainer>
        );
...
export default withTranslation()(
    withTheme(LifeStyleScreen, lifeStyleScreenStyle),
);
